...
body {margin: 0px; padding: 0px; font-family: arial, helvetica; color: #000000; font-size: 13px;}
a {color: ;}
...
#TopMenu {box-sizing: border-box; white-space: nowrap; height: 60px; padding-top: 0px; padding-left: 0px; padding-right: 0px; background-color: #ffffff;}
...
/*Main Menu CSS*/
.MenuItem {position: relative; float: left; margin-right: 0px; margin-bottom: 0px; height: 60px;}
.MenuText, .MenuTextLink {box-sizing: border-box; height: 60px; width: auto; overflow: visible; padding-top: 8px; padding-left: 10px; padding-right: 10px; text-align: left;  font-family: arial, helvetica, sans-serif; color: #000000; font-size: 12px;background-color: #ffffff;}
.MenuGraphic, .MenuGraphicLink {overflow: hidden; width: width: auto; overflow: visible; px; height: 60px;}
...
.MenuTextLink:hover {background-color: \9; color: #a9a9a9\9;}
...
/*Hover CSS*/
.MenuTextLink:hover {background-color: ; color: #a9a9a9;}
...
.MenuLinkOn {background-color: ; color: #a9a9a9;}
.LevelTwoOn {color: ;}
.LevelThreeOn {color: ;}
...
#Content {overflow: hidden; padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px;  box-sizing: border-box;}
...
#EndUserFooter {float: left; overflow: hidden; margin-top: 20px; padding-bottom: 20px;  box-sizing: border-box; width: 100%; max-width: 940px; margin-left: 0px; padding-left: 0px; padding-right: 0px;}
...
.S5385 {font-family: arial, helvetica, sans-serif; color: #000000; font-size: 12px;}
.S5386 {font-family: arial, helvetica, sans-serif; color: #000000; font-size: 12px;}
.S5387 {font-family: arial, helvetica, sans-serif; color: #535a62; font-size: 48px;}
.SPHS {font-family: arial, helvetica, sans-serif; color: #535a62; font-size: 48px;}
.S5388 {font-family: arial, helvetica, sans-serif; color: #535a62; font-size: 24px;}
.SPCS {font-family: arial, helvetica, sans-serif; color: #535a62; font-size: 24px;}
.S5389 {font-family: arial, helvetica, sans-serif; color: #535a62; font-size: 30px;}
.S5390 {font-family: arial, helvetica, sans-serif; color: #535a62; font-size: 16px;}
.PageLeftCol {float: left; width: 100px;}
.PageRightCol {float: left; width: 840px;}
...
.three-col-wrap div {min-height: 50px;}
...
.two-col-wrap div {min-height: 50px;}

@media (max-width: 1250px) {
.two-col-wrap {padding: 25px 25px 25px 25px;}
...
.two-col-wrap .image, .two-col-wrap .image p {text-align: center !important;}
...
#ContentExt {width: 100%; min-width: 100%; min-height: 400px; background-color: #f8e7c2;}
#Content {width: 100%; min-width: 100%; min-height: 400px; background-color: #f8e7c2;}
...
body, div, p, a {line-height: 1.5em;}

.S5390 {line-height: 1em;}
...
/*min-height: 100vh;
height: 100vh;*/
#Main {grid-template-rows: auto 40px auto 500px;}
row-gap: 0;
...
#site-header-logo img {width: 100%; border-radius: 0;}

#TopMenuExt {auto;}

.MenuTextLink, .MenuText, .SubMenuLink {
color: #535a62;
...
#EndUserFooter a {color: gainsboro;}
...
#SiteHeaderExt {visibility: hidden;}
...
.MenuItem, .MenuTextLink, .MenuText {
font-size: 20px;
height: 30px;
}
...
#ToggleMenu {
background-image: url("/EndUserFiles/77541.png");
...
.bar-beige, .bar-lavender, .bar-purple, .bar-gold, .bar-gray {min-height: 50px;}

.bar-beige {background-color: #f8e7c2; color: #535a62;}
.bar-beige .S5387 {color: #535a62;}
.bar-beige div a, .bar-beige div p a {color: #000000;}
.bar-lavender {background-color: #f2d8f8;}
.bar-lavender div a, .bar-lavender div p a {color: #391364;}
.bar-purple {background-color: #391364; color: #f8e7c2;}
.bar-purple .S5387 {color: #f8e7c2;}
.bar-purple div a, .bar-purple div p a {color: #ffffff;}
.bar-gold {background-color: #d8920a; color: #535a62;}
.bar-gold .S5387 {color: #535a62;}
.bar-gold div a, .bar-gold div p a {color: #000000;}


.bar-gray {background-color: #535a62;}
.bar-black {background-color: #000000; color: #ffffff;}
.bar-black .S5387 {color: #ffffff;}
.bar-black div a, .bar-black div p a {color: #000000;}
.bar-white {background-color: #ffffff;}
...
.S5387 {font-family: 'Spectral', serif; line-height: 1em;}
.S5389 {font-family: 'Spectral', serif; line-height: 1em;}


/* End Text Styles ----------------------------------------*/

.donate-light, .donate-dark {
display: inline-block;
